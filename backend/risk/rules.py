# Checking the profit margin value with the standard value for generating warning or not 
...
# Checking the revenue growth value with the standard value for generating warning or not
...
# Checking the expense growth value with the standard value for generating warning or not
...
# Checking the growth gap between the revenue growth and expense growth with the standard value for generating warning or not
...
# Checking the current ratio value with the standard value for generating warning or not
...
# Checking the reveivables ratio value with the standard value for generating warning or not
...
def evaluate_financial_risks(ratios):
    '''
    Concatenating the list of warnings that is generated by the system
    Also, returning the entire list of warnings in a single list

    '''

    warnings = []

    warning = check_profit_margin(ratios["profit_margin"])
# Appending the warning if present over there
    if warning:
    ...
    warning = check_revenue_growth(ratios["revenue_growth"])
    if warning:
        warnings.append(warning)



    warning = check_expense_growth(ratios["expense_growth"])
    if warning:
        warnings.append(warning)



    warning = check_growth_gap(ratios["revenue_growth"],ratios["expense_growth"])
    if warning:
        warnings.append(warning)



    warning = check_current_ratio(ratios["current_ratio"])
    if warning:
        warnings.append(warning)



    warning = check_receivables_ratio(ratios["receivables_ratio"])
    if warning:
        warnings.append(warning)
